...
impl DpuActor {
    ...
    fn handle_dash_ha_global_config(&mut self, state: &mut State) -> Result<()> {
        ...
        self.set_neigh_resolve(global_cfg.vnet_name.as_deref().unwrap_or(""), outgoing)?;
        Ok(())
    }
...
mod test {
    ...
    use crate::db_structs::{DashBfdProbeState, DashHaGlobalConfig, Dpu, DpuResetInfo, DpuState, NeighResolveTable, RemoteDpu};
    ...
    async fn dpu_actor() {
        ...
        let commands = [
            ...
            recv! { key: "switch0_dpu0", data: {"key": format!("{}:{}", dash_global_cfg.vnet_name.as_ref().unwrap(), dpu_actor_state_wo_bfd.pa_ipv4.clone()), "operation": "Set", "field_values": {"mac":"00:00:00:00:00:00"}},
