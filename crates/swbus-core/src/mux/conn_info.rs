...
pub struct SwbusConnInfo {
    ...
    #[getset(get = "pub")]
    remote_service_path: Option<ServicePath>,
}
...
impl SwbusConnInfo {
    ...
    pub fn new_server(
        ...
        SwbusConnInfo {
            ...
            remote_addr,
            connection_type: conn_type,
            remote_service_path: Some(remote_service_path),
        }
    }

    pub fn with_remote_service_path(mut self, remote_service_path: ServicePath) -> Self {
        self.remote_service_path = Some(remote_service_path);
        self
    }
}
...
mod tests {
    ...
    fn new_client_conn_info_should_succeed() {
        ...
        let conn_info = SwbusConnInfo::new_client(ConnectionType::InCluster, remote_addr);
        ...
        assert_eq!(conn_info.remote_service_path(), &None);
    }
    ...
    fn new_server_conn_info_should_succeed() {
        ...
        assert_eq!(conn_info.remote_service_path(), &Some(remote_service_path));
    }
}
